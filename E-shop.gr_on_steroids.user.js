...
function main() {
    ...
    document.body.onkeydown = function(event) { //press s and search focuses
        if (event.keyCode == 83) {
            setTimeout(function() {
                document.getElementById("autocompletebox").focus();
            }, 50);
        }
    };
    ...
    img.src = "https://raw.githubusercontent.com/JimTortex/E-shop.gr_on_steroids/master/images/show.png";
    img.title = "Show Secret menu";
